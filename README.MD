...
####  Python 3.10, Visual Studio Code, Jupyter Notebook, PyCharm Community Ed., Seaborn, Plotly, Plotly Express, Pandas, Numpy, Folium, Geopandas, Streamlit Web Apps e Streamlit-Folium.
